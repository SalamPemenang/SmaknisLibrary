		...
		<table class="tabel">
			...
			<tbody>
				<tr>
					...
					<td>	
						<a href="{{ route('operator.anggotatipe.edit', $at->anggota_tipe_id) }}"><button>Ubah</button></a> ||
						<form action="{{ route('operator.anggotatipe.hapus', $at->anggota_tipe_id) }}" method="POST">
							@csrf
