			...
			<div class="x_content">
				...
				<form action="{{ route('operator.biblio.ubah', $biblio->biblio_id) }}" method="POST" class="form-horizontal form-label-left input_mask" enctype="multipart/form-data">
					...
					<div class="col-md-6 col-sm-6 col-xs-12 form-group">
						...
						<input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror" autocomplete="off" value="{{ $biblio->judul }}">
						@error('judul')
					...
					<div class="col-md-6 col-sm-6 col-xs-12 form-group">
						<div class="row">
							<div class="col-md-6">
								...
								<input type="text" name="edisi" class="form-control @error('edisi') is-invalid @enderror" autocomplete="off" value="{{ $biblio->edisi }}">
								@error('edisi')
									<span class="invalid-feedback" role="alert">
										<strong>{{ $message }}</strong>
									</span>
							...
							<div class="col-md-6">
								...
								<input type="text" name="penerbit_tempat" class="form-control @error('penerbit_tempat') is-invalid @enderror" autocomplete="off" value="{{ $biblio->penerbit_tempat }}">
					...
					<div class="col-md-6 col-sm-6 col-xs-12 form-group">
						...
						<select name="penulis_id" id="penulis_cari" class="form-control @error('penulis_id') is-invalid @enderror">
					...
					<div class="col-md-6 col-sm-6 col-xs-12 form-group">
						...
						<input type="text" name="isbn" class="form-control @error('isbn') is-invalid @enderror" autocomplete="off" value="{{ $biblio->isbn }}">
						@error('isbn')
							<span class="invalid-feedback" role="alert">
								<strong>{{ $message }}</strong>
							</span>
					...
					<div class="col-md-6 col-sm-6 col-xs-12 form-group">
						<div class="row">
							<div class="col-md-6 col-sm-6 col-xs-12 form-group">
								...
								<input type="text" name="harga_buku" class="form-control @error('harga') is-invalid @enderror" autocomplete="off" value="{{ $biblio->harga_buku }}">
								@error('harga')
								<span class="invalid-feedback" role="alert">
									<strong>{{ $message }}</strong>
								</span>
							...
							<div class="col-md-6 col-sm-6 col-xs-12 form-group">
								...
								<input type="text" name="penerbit_tahun" class="form-control @error('penerbit_tahun') is-invalid @enderror" id="penerbit_tahun" autocomplete="off" value="{{ $biblio->penerbit_tahun }}">
					...
					<div class="col-md-12 form-group">
						...
						<textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" rows="10" id="deskripsi">{{ $biblio->deskripsi }}</textarea>
						@error('deskripsi')
							<span class="invalid-feedback" role="alert">
								<strong>{{ $message }}</strong>
							</span>
					...
					<div class="col-md-6 col-sm-6 col-xs-12 form-group">
						...
						<select name="sumber_item_id" class="form-control @error('sumber_item_id') is-invalid @enderror">
